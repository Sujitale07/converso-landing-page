...
import { Props, desktopHeaderPhrase, subtextPhrase, testimonials } from './constants';
    ...
    <Wrapper>
      <Inner>
        <Header>
          ...
          <MaskText phrases={subtextPhrase} tag="p" />
        </Header>
        <TestimonialWrapper>
            ...
            <Testimonial key={i}>
              ...
              <UserInfo>
                <Name>
                  ...
                  <MaskText phrases={new Array('Happy Connectapre User')} tag="p" />
                </Name>
                <Avatar>
