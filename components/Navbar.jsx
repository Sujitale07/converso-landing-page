...
export default function Navbar() {
    ...
    return (
        <nav className={`flex items-center justify-between fixed z-50 top-0 w-full px-6 md:px-16 lg:px-24 xl:px-32 md:py-0 py-2 border-b border-slate-200 bg-white/40 ${openMobileMenu ? 'bg-white/80' : 'backdrop-blur'}`}>
            <a href="/">
            ...
            <div className="flex items-center gap-4">
                ...
                <Link href="https://wordpress.org/plugins/connectapre/" className="hidden md:block px-4 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md">
                    Download Plugin
                </Link>
