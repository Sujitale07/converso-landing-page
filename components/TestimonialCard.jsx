export default function TestimonialCard({ testimonial }) {
    return (
        <div className="p-6 rounded-2xl mx-4 bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 w-80 shrink-0">
            <div className="flex flex-col gap-3">
                ...
                <p className="text-sm text-slate-700 leading-relaxed italic">"{testimonial.content}"</p>
            </div>
        </div>
    );
}