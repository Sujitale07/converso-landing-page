...
export default function Pricing() {
    return (
        <>
            <SectionTitle text1="Pricing" text2="Simple, Transparent Pricing" text3="Choose the license that fits your business needs. One-time payment options or annual subscriptions available." />
