...
export const FaqSection = () => {
    ...
    return (
        <div id="faq" className="max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            <SectionTitle text1="FAQ's" text2="Frequently asked questions" text3="Everything you need to know about Connectapre's features and technical requirements." />
            <div className="mt-8">
